...
<div class="container">
  ...
  <div class="panel panel-danger">
      ...
      <h2><div class="panel-heading">Personal Details</div></h2>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="email" class="form-control" id="email" placeholder="Enter Mobile" name="email">
      </div>
    </div>
    ...
    <div class="panel panel-danger">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Caste Details</a>
        </h4>
      </div>
    ...
    <div class="panel panel-danger">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Income Details</a>
        </h4>
      </div>
